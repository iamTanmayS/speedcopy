...
export interface SubAdminProfile {
    ...
    hubIds: UUID[];     // accessible hubs
    cityIds: UUID[];    // accessible cities
    isActive: boolean;
...
export interface RevenueReport {
    ...
    cogs: PaisaAmount; // Cost of goods sold (vendor payouts)
...
export interface ExportJob {
    ...
    downloadUrl?: string; // Pre-signed S3 URL, expires

...
export const getAdminDashboard = async (req: AuthRequest, res: Response) => {
    try {
        ...
        const orders: OrderStatsSummary = {
            ...
            slaBreachRatePercent: 0,        // requires SLA tracking table
        ...
        const vendors: VendorPerformanceSummary = {
            ...
            avgAcceptanceTime: 0,           // requires acceptance timestamp tracking
            avgProductionTime: 0,
        ...
        const hubRows = await pool.query(`
            SELECT
                ...
                COUNT(o.id) FILTER (WHERE o.status = 'QC_HOLD') AS sla_risk_orders,
